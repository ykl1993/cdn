...
使用回源HOST，您可以自定义CDN节点回源时所需访问的具体服务器域名。您可以选择三种域名类型：加速域名、源站域名或自定义域名。
...
## 实例 {#section_ids_1sd_l2b .section}

例一

如果你的源站是域名源站`www.a.com`，且将回源HOST设置为`www.b.com`， 则实际回源的是 `www.a.com`解析到的IP站点`www.b.com`。
