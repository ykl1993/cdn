...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/5111/15444955966046_zh-CN.png)
...
3.  配置**加速域名**和**资源分组**，然后选择业务类型和源站类型。
    ...
    **说明：** 
    ...
    -   [加速域名说明](intl.zh-CN/快速入门/快速入门.md#)
    -   业务类型说明
    -   源站类型说明
    -   加速区域说明
4.  单击**下一步**，等待审核。
...
|[直播流媒体](../../../../intl.zh-CN/用户指南/业务类型/类型4：直播流媒体加速.md#)|目前直播服务已经独立，请参考[视频直播](https://www.alibabacloud.com/product/apsaravideo-for-live)。|
|[全站加速](../../../../intl.zh-CN/用户指南/业务类型/类型5：全站加速.md#)| 如果您的网站或应用含有大量动静态内容混合、且较多为动态资源请求，您可以使用全站加速。

 目前阿里云全站加速已经商业化，请参考[全站加速](https://www.alibabacloud.com/product/dcdn)。
