...
请求的资源不需要都回您的源站获取，避免了网络拥塞、分担源站压力，保证用户访问资源的速度和体验。您可以参考 [快速入门](../../../../intl.zh-CN/快速入门/快速入门.md#)快速接入阿里云CDN。
...
-   [过滤参数](../../../../intl.zh-CN/用户指南/域名管理/性能优化设置/过滤参数.md#)：是指当URL请求中带并携带参数请求到CDN节点的时候，CDN节点在收到该请求后是否将该带参数的请求URL请求回源站。
